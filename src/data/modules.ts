...
void printarray(int arra[]) {
    for(int i = 0; i < size; i++) {
      ...
      {
        id: "t1_6",
        title: "In-Place Element Squaring (squareelement)",
        description: "Implement squareelement(int arra[]) to square each element of an array {2, 3, 4, 5, 6} in-place (arra[i] *= arra[i]) and print using printarray.",
        difficulty: "Beginner",
        optimalTimeComplexity: "O(n)",
        optimalSpaceComplexity: "O(1)",
        complexityNotes: "Iterating through the array and squaring each element directly in-place runs in linear O(n) time.",
        initialCode: `#include <iostream>
using namespace std;
...
int main() {
    // تعريف مصفوفة وإعطاؤها أرقام بسيطة لسهولة ملاحظة التربيع
    int myArray[size] = {2, 3, 4, 5, 6};

    cout << "--- عناصر المصفوفة قبل التربيع ---" << endl;
    printarray(myArray);

    // استدعاء دالة التربيع، ولا تحتاج إلى تمرير رقم إضافي هنا
    cout << "\\n--- جاري تربيع جميع العناصر... ---" << endl;
    squareelement(myArray);

    cout << "\\n--- عناصر المصفوفة بعد التربيع ---" << endl;
    printarray(myArray);

    return 0;
}

// بناء دالة التربيع (squareelement)
void squareelement(int arra[]) {
    // TODO: تمر الحلقة على كل عنصر وتضربه في نفسه (arra[i] *= arra[i])
    for(int i = 0; i < size; i++) {
...
// بناء دالة التربيع (squareelement)
void squareelement(int arra[]) {
    // تمر الحلقة على كل عنصر وتضربه في نفسه
    for(int i = 0; i < size; i++) {
        arra[i] *= arra[i]; // هذه العبارة تعادل: arra[i] = arra[i] * arra[i];
    }	
}
...
void printarray(int arra[]) {
    for(int i = 0; i < size; i++) {
        ...
        solutionRegex: "arra\\[i\\]\\s*\\*=\\s*arra\\[i\\]|arra\\[i\\]\\s*=\\s*arra\\[i\\]\\s*\\*\\s*arra\\[i\\]",
        frames: [
          {
          ...
          {
            description: "squareelement: arra[4] = 6 * 6 = 36. All elements squared!",
            array: [4, 9, 16, 25, 36],
            pointers: { i: 4 },
            highlightIndices: [4],
      ...
      {
        id: "t1_7",
        title: "In-Place Scalar Subtraction (subelement)",
        description: "Implement subelement(int arra[], int ele) to subtract a scalar ele (5) from every element of array {15, 25, 35, 45, 55} in-place.",
        difficulty: "Beginner",
        optimalTimeComplexity: "O(n)",
        optimalSpaceComplexity: "O(1)",
        complexityNotes: "Traversing n array elements and subtracting ele in-place takes linear O(n) time.",
        initialCode: `#include <iostream>
using namespace std;
...
int main() {
    // تعريف مصفوفة وإعطاؤها قيم ابتدائية
    int myArray[size] = {15, 25, 35, 45, 55};

    cout << "--- عناصر المصفوفة قبل الطرح ---" << endl;
    printarray(myArray);

    // استدعاء دالة الطرح، وسنطلب منها طرح الرقم (5) من كل عنصر
    cout << "\\n--- جاري طرح الرقم 5 من جميع العناصر... ---" << endl;
    subelement(myArray, 5);

    cout << "\\n--- عناصر المصفوفة بعد الطرح ---" << endl;
    printarray(myArray);

    return 0;
}

// بناء دالة الطرح (subelement)
void subelement(int arra[], int ele) {
    // TODO: تمر الحلقة على كل عنصر وتطرح منه القيمة الممررة (ele)
    for(int i = 0; i < size; i++) {
...
// بناء دالة الطرح (subelement)
void subelement(int arra[], int ele) {
    // تمر الحلقة على كل عنصر وتطرح منه القيمة الممررة (ele)
    for(int i = 0; i < size; i++) {
        arra[i] -= ele; // هذه العبارة تعادل: arra[i] = arra[i] - ele;
    }	
}
...
int positionsearch(int arra[], int ele) {
    ...
    return -1; // تم إضافة إرجاع افتراضي لتجنب تحذيرات المترجم (Compiler)
      ...
      {
        id: "t3_6",
        title: "Find All Occurrence Positions with Global Flag (allposition)",
        description: "Implement allposition(int arra[], int num) to print all indices where num appears in array {15, 20, 15, 30, 15}, updating global flag bool x = true.",
        difficulty: "Beginner",
        optimalTimeComplexity: "O(n)",
        optimalSpaceComplexity: "O(1)",
        complexityNotes: "Scanning all n positions to locate every occurrence takes linear O(n) time.",
        initialCode: `#include <iostream>
using namespace std;
...
// متغير عام يستخدمه البرنامج كعلامة (Flag)
bool x = false; 
...
int main() {
    // تعريف مصفوفة تحتوي على رقم مكرر لنتمكن من رؤية عمل الدالة
    // الرقم 15 مكرر في المواقع 0 و 2 و 4
    int myArray[size] = {15, 20, 15, 30, 15};
    
    int searchNumber;

    cout << "--- برنامج البحث عن جميع مواقع العنصر ---" << endl;
    cout << "عناصر المصفوفة هي: 15, 20, 15, 30, 15\\n" << endl;

    // --- التجربة: البحث عن رقم مكرر ---
    searchNumber = 15;
    
    // نتأكد أن x قيمتها false قبل بدء البحث
    x = false; 
    
    // استدعاء الدالة، وهي ستقوم بالطباعة مباشرة من داخلها
    allposition(myArray, searchNumber);
    cout << endl; // سطر جديد لترتيب المخرجات
    
    // إذا انتهت الدالة وظلت x بقيمتها false، فهذا يعني أن الرقم لم يُطبع أبداً
    if(x == false) {
        cout << "النتيجة: الرقم " << searchNumber << " غير موجود في المصفوفة.\\n" << endl;
    }
...
// بناء دالة البحث عن جميع المواقع (allposition)
void allposition(int arra[], int num) {
    // طباعة الجملة التمهيدية
    cout << "the positions of number:" << num << "  are : ";
    
    // TODO: تمر الحلقة على كل عنصر في المصفوفة وتطبع الفهرس عند التطابق مع تعيين x = true
    for(int i = 0; i < size; i++) {
...
void allposition(int arra[], int num) {
    ...
    for(int i = 0; i < size; i++) {
        // إذا وجدنا الرقم المطلوب
        if(arra[i] == num) {
            cout << i << "  "; // نطبع موقع العنصر (الفهرس i)
            x = true;          // نغير المتغير العام x إلى صحيح
        }	
    }
}`,
        solutionRegex: "if\\s*\\(arra\\[i\\]\\s*==\\s*num\\)\\s*\\{\\s*cout\\s*<<\\s*i.*?x\\s*=\\s*true;\\s*\\}",
        frames: [
          {
      ...
      {
        id: "t3_7",
        title: "Dynamic Array Linear Search (searchValue)",
        description: "Read n numbers and locate the first occurrence of a search value returning the index or -1 if not found.",
        difficulty: "Beginner",
        optimalTimeComplexity: "O(n)",
        optimalSpaceComplexity: "O(1)",
        complexityNotes: "Linear search checks up to n elements, terminating on first match in O(n) worst-case.",
        initialCode: `#include <iostream>
using namespace std;

int searchValue(int a[], int n, int value)
{
    // TODO: Iterate over elements and return index if a[i] == value
    for (int i = 0; i < n; i++)
    {
...
int main()
{
    ...
    int result = searchValue(a, n, value);
...
int main()
{
    ...
    return 0;
        ...
        solutionRegex: "if\\s*\\(a\\[i\\]\\s*==\\s*value\\)\\s*\\{\\s*return\\s+i;\\s*\\}",
        frames: [
          {
      ...
      {
        id: "t3_8",
        title: "Generic Template Linear Search (search<T>)",
        description: "Implement a generic template function template <typename T> int search(T arr[], int size, T target) to search arrays of ints, strings, and doubles.",
        difficulty: "Intermediate",
        optimalTimeComplexity: "O(n)",
        optimalSpaceComplexity: "O(1)",
        complexityNotes: "Template instantiation compiles type-safe linear search for any type T with O(n) time complexity.",
        initialCode: `#include <iostream>
#include <string>
using namespace std;

// TODO: Define generic template function search<T>
template <typename T>
...
int main() {
    ...
    cout << "Index in nums: " << search(nums, 5, 30) << endl;  // 2
    
    // كلمات نصية
    string words[] = {"apple", "banana", "cherry"};
    cout << "Index in words: " << search(words, 3, string("banana")) << endl;  // 1
    
    // أرقام عشرية
    double decimals[] = {1.5, 2.5, 3.5};
    cout << "Index in decimals: " << search(decimals, 3, 2.5) << endl;  // 1
...
int main() {
    ...
    return 0;
        ...
        solutionRegex: "template\\s*<.*?typename|class\\s+T>\\s*int\\s+search.*?if\\s*\\(arr\\[i\\]\\s*==\\s*target\\)\\s*return\\s+i;",
        frames: [
          {
      ...
      {
        id: "t3_9",
        title: "Iterative & Recursive Binary Search with Overflow Guard",
        description: "Implement both iterative binarySearch and recursive binarySearchRecursive using mid = left + (right - left) / 2 to search sorted array {10, 25, 35, 45, 55, 65, 75, 85, 95}.",
        difficulty: "Intermediate",
        optimalTimeComplexity: "O(log n)",
        optimalSpaceComplexity: "O(1) Iterative / O(log n) Recursive",
        complexityNotes: "Repeatedly dividing search range in half yields logarithmic O(log n) time.",
        initialCode: `#include <iostream>
using namespace std;

// البحث الثنائي - يتطلب مصفوفة مرتبة تصاعدياً
int binarySearch(int arr[], int size, int target) {
    int left = 0;
    int right = size - 1;
    
    while (left <= right) {
        int mid = left + (right - left) / 2;  // لتجنب overflow
        
        // TODO: Complete iterative binary search branches
        if (arr[mid] == target) {
            return mid;  // وجدنا القيمة
        }
...
// نسخة تستخدم الـ Recursion
int binarySearchRecursive(int arr[], int left, int right, int target) {
    if (left > right) return -1;
    
    int mid = left + (right - left) / 2;
    
    // TODO: Recursive branches
...
int main() {
    int arr[] = {10, 25, 35, 45, 55, 65, 75, 85, 95};
    ...
    if (result != -1) {
        cout << "القيمة " << target << " موجودة في الموقع: " << result << endl;
    } else {
        cout << "القيمة غير موجودة" << endl;
    }
...
int main() {
    ...
    return 0;
        ...
        solutionRegex: "mid\\s*=\\s*left\\s*\\+\\s*\\(right\\s*-\\s*left\\)\\s*/\\s*2.*?binarySearchRecursive",
        frames: [
          {
      ...
      {
        id: "t3_10",
        title: "Unsorted Array Linear Search",
        description: "Perform a linear scan on an unsorted array {45, 12, 78, 23, 67, 89, 34} using sizeof(arr)/sizeof(arr[0]) to find target 67.",
        difficulty: "Beginner",
        optimalTimeComplexity: "O(n)",
        optimalSpaceComplexity: "O(1)",
        complexityNotes: "Linear search operates on arbitrary unsorted arrays in O(n) linear time.",
        initialCode: `#include <iostream>
using namespace std;

// البحث الخطي - يعمل على أي مصفوفة (مرتبة أو غير مرتبة)
int linearSearch(int arr[], int size, int target) {
    // TODO: Loop through all elements and return index if arr[i] == target
    for (int i = 0; i < size; i++) {
...
int main() {
    ...
    if (result != -1) {
        ...
        cout << "القيمة " << target << " غير موجودة في المصفوفة" << endl;
    }
...
int main() {
    ...
    return 0;
        ...
        solutionRegex: "if\\s*\\(arr\\[i\\]\\s*==\\s*target\\)\\s*\\{\\s*return\\s+i;\\s*\\}",
        frames: [
          {
  ...
  {
    id: "m5",
    title: "Module 5: 2D Matrices & Grid Transformations",
    description: "Multidimensional arrays, row/column traversals, and 2D matrix transposition.",
    tasks: [
      {
        id: "t5_1",
        title: "4x4 Matrix Transposition",
        description: "Compute and print the transpose of a 4x4 2D matrix transpose[j][i] = x[i][j] with positive/negative numbers and tab formatting.",
        difficulty: "Intermediate",
        optimalTimeComplexity: "O(n²)",
        optimalSpaceComplexity: "O(n²)",
        complexityNotes: "Transposing an n x n matrix inspects all n² cells in nested loops of quadratic O(n²) time.",
        initialCode: `#include <iostream>
...
int main() {
    ...
    // TODO: Perform transposition: transpose[j][i] = x[i][j]
    for (int i = 0; i < 4; ++i) {
        for (int j = 0; j < 4; ++j) {
...
int main() {
    ...
    return 0;
        ...
        solutionRegex: "transpose\\[j\\]\\[i\\]\\s*=\\s*x\\[i\\]\\[j\\]",
        frames: [
          {
...
int main()
{
    ...
    return 0;
      ...
      {
        id: "t7_10",
        title: "Interactive Stack Operations & Menu System",
        description: "Implement a full array-based Stack supporting push, pop, peek, isEmpty, isFull, and display with a do-while switch-case interactive console menu.",
        difficulty: "Intermediate",
        optimalTimeComplexity: "O(1) push/pop/peek | O(n) display",
        optimalSpaceComplexity: "O(n)",
        complexityNotes: "Constant-time O(1) top modifications with linear O(n) stack display traversal.",
        initialCode: `#include <iostream>
using namespace std;
...
bool isFull()
{
    // TODO: Return true if top == SIZE - 1
    return top == SIZE - 1;
}
...
void pop()
{
    ...
    cout << "Removed: " << stackArray[top] << endl;
...
void peek()
{
    ...
    cout << "Top value: " << stackArray[top] << endl;
}
...
int main()
{
    // Demonstration of menu operations: push, display, peek, pop
    push(10);
    push(20);
    push(30);
    display();
...
int main()
{
    ...
    return 0;
        ...
        solutionRegex: "bool\\s+isEmpty.*?return\\s+top\\s*==\\s*-1;.*?bool\\s+isFull.*?return\\s+top\\s*==\\s*SIZE\\s*-\\s*1;.*?void\\s+push.*?void\\s+pop.*?void\\s+peek.*?void\\s+display",
        frames: [
          {
